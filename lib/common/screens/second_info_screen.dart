...
// import 'package:dating/features/auth/screens/community.dart';
// import 'package:dating/features/auth/screens/permision_screen.dart';
import 'package:matrimony_admin/common/widgets/circular_bubles.dart';
import 'package:flutter/material.dart';
import 'package:flutter_animate/flutter_animate.dart';

import '../../globalVars.dart';

class ImportantInfo1 extends StatefulWidget {
  final VoidCallback callback;
  const ImportantInfo1({super.key, required this.callback});

  @override
  State<ImportantInfo1> createState() => _ImportantInfo1State();
}

class _ImportantInfo1State extends State<ImportantInfo1> {
  void showinfo() {
    showDialog(
      context: context,
      builder: (context) {
