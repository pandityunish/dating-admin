...
class Response {
    ...
    factory Response.fromJson(Map<String, dynamic> json) => Response(
        ...
        manglikdoshSaturnPoints: Points.fromJson(json["manglikdosh_saturn_points"]),
        manglikdoshRahuketu: json["manglikdosh_rahuketu"],
        manglikdoshRahuketuPoints: Points.fromJson(json["manglikdosh_rahuketu_points"]),
        score: json["score"],
...
class MangaldoshPoints {
    ...
    factory MangaldoshPoints.fromJson(Map<String, dynamic> json) => MangaldoshPoints(
        boy: json["boy"],
        girl: json["girl"],
    );
