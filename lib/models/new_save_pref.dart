...
//
//     final newSavePrefModel = newSavePrefModelFromJson(jsonString);

import 'dart:convert';

NewSavePrefModel newSavePrefModelFromJson(String str) => NewSavePrefModel.fromJson(json.decode(str));

String newSavePrefModelToJson(NewSavePrefModel data) => json.encode(data.toJson());
...
class NewSavePrefModel {
    ...
    factory NewSavePrefModel.fromJson(Map<String, dynamic> json) => NewSavePrefModel(
        id: json["_id"],
        email: json["email"],
        ...
        kundaliDoshList: List<dynamic>.from(json["kundaliDoshList"].map((x) => x)),
        maritalStatusList: List<dynamic>.from(json["maritalStatusList"].map((x) => x)),
        ...
        disabilityList: List<dynamic>.from(json["disabilityList"].map((x) => x)),
        heightList: List<dynamic>.from(json["heightList"].map((x) => x)),
        educationList: List<dynamic>.from(json["educationList"].map((x) => x)),
        professionList: List<dynamic>.from(json["professionList"].map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "maritalStatusList": List<dynamic>.from(maritalStatusList.map((x) => x)),
