...
class FemaleAgeSelectionScreen extends StatefulWidget {
  
  const FemaleAgeSelectionScreen({super.key, });

  @override
  State<FemaleAgeSelectionScreen> createState() => _AgeSelectionScreenState();
}

class _AgeSelectionScreenState extends State<FemaleAgeSelectionScreen> {
  int _minAge =21;
  int _maxAge = 70;
