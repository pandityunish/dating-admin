                ...
                child: Material(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.error,color: main_color,size: 70,),
                          SizedBox(height: 10,),
                          Text("Opps",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                          SizedBox(height: 20,),
                          Text("Under Maintenance!",style: TextStyle(fontWeight: FontWeight.normal,fontSize: 20),),
                           Text("Sorry For The Inconvenience!",style: TextStyle(fontWeight: FontWeight.normal,fontSize: 20),),
