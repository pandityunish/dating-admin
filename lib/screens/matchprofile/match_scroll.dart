...
class _SlideProfileState extends State<MatchSlideProfile> {
  ...
  void getalluserlists() async {
    if (widget.user_list == null || widget.user_list.isEmpty) {
      load = true;
      setState(() {});
      if (homeservice.saveprefdata1.value.ageList.isNotEmpty ||
          homeservice.saveprefdata1.value.dietList.isNotEmpty ||
          homeservice.saveprefdata1.value.disabilityList.isNotEmpty ||
          homeservice.saveprefdata1.value.drinkList.isNotEmpty ||
          homeservice.saveprefdata1.value.educationList.isNotEmpty ||
          homeservice.saveprefdata1.value.dietList.isNotEmpty ||
          homeservice.saveprefdata1.value.heightList.isNotEmpty ||
          homeservice.saveprefdata1.value.incomeList.isNotEmpty ||
          homeservice.saveprefdata1.value.kundaliDoshList.isNotEmpty ||
          homeservice.saveprefdata1.value.location.isNotEmpty ||
          homeservice.saveprefdata1.value.maritalStatusList.isNotEmpty ||
          homeservice.saveprefdata1.value.professionList.isNotEmpty ||
          homeservice.saveprefdata1.value.religionList.isNotEmpty ||
        ...
        newuserlists = await homeservice.getalluserdata(
            ...
            page: 1,
            ages: homeservice.saveprefdata1.value.ageList,
            ...
            maritalStatusList:
                homeservice.saveprefdata1.value.maritalStatusList,
...
// }).toList();
      List<Matchusermodel> profilematch = await Future.wait(
        newuserlists.map((user) async {
          double distance =
              await ProfileMatch().getallusermatch(user!, widget.userSave);
                      ...
                      : PageView.builder(
                          ...
                          onPageChanged: (index) async {
                            if (index == newuserlists.length - 4) {
                              ...
                              setState(() {});
                              if (homeservice.saveprefdata1.value.ageList.isNotEmpty ||
                                  homeservice.saveprefdata1.value.dietList
                                      .isNotEmpty ||
                                  homeservice.saveprefdata1.value.disabilityList
                                      .isNotEmpty ||
                                  homeservice.saveprefdata1.value.drinkList
                                      .isNotEmpty ||
                                  homeservice.saveprefdata1.value.educationList
                                      .isNotEmpty ||
                                  homeservice.saveprefdata1.value.dietList
                                      .isNotEmpty ||
                                  homeservice.saveprefdata1.value.heightList
                                      .isNotEmpty ||
                                  homeservice.saveprefdata1.value.incomeList
                                      .isNotEmpty ||
                                  homeservice.saveprefdata1.value
                                      .kundaliDoshList.isNotEmpty ||
                                  homeservice.saveprefdata1.value.location
                                      .isNotEmpty ||
                                  homeservice.saveprefdata1.value
                                      .maritalStatusList.isNotEmpty ||
                                  homeservice.saveprefdata1.value.professionList
                                      .isNotEmpty ||
                                  homeservice.saveprefdata1.value.religionList
                                      .isNotEmpty ||
                                  homeservice.saveprefdata1.value.smokeList
                                      .isNotEmpty) {
                                List<NewUserModel> getdata = await homeservice.getalluserdata(
                                    gender: widget.userSave.gender == "male"
                                        ? "female"
                                        : "male",
                                    email: widget.userSave.email!,
                                    religion: widget.userSave.religion!,
                                    page: pagecount,
                                    ages:
                                        homeservice.saveprefdata1.value.ageList,
                                    religionList: homeservice
                                        .saveprefdata1.value.religionList,
                                    kundaliDoshList: homeservice
                                        .saveprefdata1.value.kundaliDoshList,
                                    citylocation: homeservice
                                        .saveprefdata1.value.citylocation,
                                    statelocation: homeservice
                                        .saveprefdata1.value.statelocation,
                                    maritalStatusList: homeservice
                                        .saveprefdata1.value.maritalStatusList,
                                    dietList: homeservice
                                        .saveprefdata1.value.dietList,
                                    drinkList: homeservice
                                        .saveprefdata1.value.drinkList,
                                    smokeList: homeservice
                                        .saveprefdata1.value.smokeList,
                                    disabilityList: homeservice.saveprefdata1.value.disabilityList,
                                    heightList: homeservice.saveprefdata1.value.heightList,
                                    educationList: homeservice.saveprefdata1.value.educationList,
                                    professionList: homeservice.saveprefdata1.value.professionList,
                                ...
                                print("somelsj;aflkd");
                                print(pagecount);
                                List<NewUserModel> getdata =
                                    await homeservice.getalluserdata(
                                        page: pagecount,
                                        gender: widget.userSave.gender == "male"
                                            ? "female"
                                            : "male",
