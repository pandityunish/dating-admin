...
import 'package:matrimony_admin/screens/profie_types/slider_edit_admin.dart';
...
class EditAdminProfile extends StatefulWidget {
  ...
  const EditAdminProfile({super.key, required this.model});

  @override
  State<EditAdminProfile> createState() => _EditAdminState();
}

class _EditAdminState extends State<EditAdminProfile> {
...
"CAN SEND AUDIO CLIP BULK ",
  ...
  void initState() {
    ...
    useremail.text = widget.model.email;
    geteditdata();
    selectedFeatures.addAll(widget.model.permissions);
    if (widget.model.permissions.contains("All")) {
      selectedFeatures.add("All Access");
    } else if (widget.model.permissions.isEmpty) {
  ...
  List<EditAdminModel> getalleditadmins = [];
  void geteditdata() async {
    EditAdminModel editadmins = EditAdminModel(
        email: "12345",
        editname: "",
        lat: 0,
        permissions: [],
        ...
        isLogOut: "",
        createdAt: "");
    List<EditAdminModel> getalleditadmin =
        await CreateAdminService().geteditadmins(email: widget.model.email);
    getalleditadmins = [editadmins, ...getalleditadmin];
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return MediaQuery(
      ...
      child: Scaffold(
          ...
          body: getalleditadmins.isEmpty
              ? Center()
              : PageView.builder(
                  itemCount: getalleditadmins.length,
                  controller: _pageController,
                  itemBuilder: (context, index) {
                    if (getalleditadmins[index].email == "12345") {
                            ...
                            children: [
                              ...
                              SizedBox(height: 5,),
                               index==0?       Column(
                                ...
                                children: [
                      Text("(Active)",style: TextStyle(color: main_color),),

                                  SizedBox(
                                    width: Get.width ,
                                    child: ElevatedButton(
                                      onPressed: () async {
                                        AuthService().updatelogin(
                                        ...
                                        SearchProfile().addtoadminnotification(
                                            ...
                                            title:
                                                "${userSave.displayName} LOGOUT ${widget.model.username} SUCCESSFULLY ",
                                                ...
                                                .addtoadminnotification(
                                                    ...
                                                    userimage: userSave
                                                        ...
                                                        : userSave
                                                            .imageUrls![0],
                                                    title:
                                                        "${userSave.displayName} EDIT SUB-ADMIN NAME ${widget.model.username} TO SUB-ADMIN ${name.text} SUCCESSFULLY ",
                                                    email: userSave.email!,
                                                    subtitle: "");
                                          }
                                          if (widget.model.email !=
                                              useremail.text) {
                                            SearchProfile()
                                                .addtoadminnotification(
                                                    userid: "",
                                                    ...
                                                    userimage: userSave
                                                        ...
                                                        : userSave
                                                            .imageUrls![0],
                                                    title:
                                                        "${userSave.displayName} EDIT SUB-ADMIN ${widget.model.username} EAMIL ${widget.model.email} TO ${useremail.text} ",
                                                    email: userSave.email!,
                                                    subtitle: "");
                                          }
                                          if (selectedFeatures !=
                                              widget.model.permissions) {
                                            SearchProfile()
                                                .addtoadminnotification(
                                                    userid: "",
                                                    useremail:
                                                    ...
                                                    userimage: userSave
                                                        ...
                                                        : userSave
                                                            .imageUrls![0],
                                                    title:
                                                        "${userSave.displayName} EDIT SUB-ADMIN ${useremail.text} ACCESS ",
                                                    email: userSave.email!,
                                                    subtitle: "");
                                          }
                      ...
                      return EditSliderAdminProfile(
                        model: getalleditadmins[index],
