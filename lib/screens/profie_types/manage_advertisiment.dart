...
class _ManageAdvertisimentState extends State<ManageAdvertisiment> {
  ...
  {"name": "After Click on Download Matrimonial Biodata Left Menu", "id": "60"},
  {"name": "After Click on Download with Contact Button In DMB", "id": "61"},
  {"name": "After Click on Download Without Contact Button In DMB", "id": "62"},
  ...
  {"name": "When Admin Send Link to Improve About Partner Preference", "id": "73"},
  ...
  {"name": "After Click on Interest Sent Successfully Notification", "id": "91"},
  {"name": "After Click on Interest Cancel Successfully Notification", "id": "92"},
  ...
  {"name": "After Click on Unshortlist Successfully Notification", "id": "101"},
  ...
  title: "${userSave.displayName} SEEN ADVERTISIMENT-${index+1} IN MANAGE ADVERTISIMENT", email: userSave.email!, subtitle: "");
                            if(ads[index]=="when sign up complete"){
                            Get.to(()=>WhenSignUp());
                            } else if(ads[index]["name"]=="Occasion Wish"){} else{
 Get.to(AdvertisementDetails(id: ads[index]["id"],));
                            }
                          },
