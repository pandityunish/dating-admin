...
class EditSliderAdminProfile extends StatefulWidget {
  final EditAdminModel model;
  final PageController pageController;
  const EditSliderAdminProfile(
      {super.key, required this.model, required this.pageController});

  @override
  State<EditSliderAdminProfile> createState() => _EditAdminState();
}

class _EditAdminState extends State<EditSliderAdminProfile> {
          ...
          child: Padding(
            ...
            child: Column(
                    ...
                    child: Card(
                      ...
                      child: CupertinoTextField(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(
                            color:
                                _focusNode1.hasFocus ? main_color : Colors.transparent,
                          ),
                    ...
                    child: Card(
                      ...
                      child: CupertinoTextField(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(
                            color:
                                _focusNode2.hasFocus ? main_color : Colors.transparent,
                          ),
                          borderRadius: BorderRadius.circular(30),
                        ),
                        textInputAction: TextInputAction.next,
              ...
              const  SizedBox(height: 20,),
                ...
                Text(
                 "${widget.model.editname} ${DateFormat('EEEE MMMM d y HH:mm') .format(DateTime.parse(widget.model.createdAt).toLocal())}",
