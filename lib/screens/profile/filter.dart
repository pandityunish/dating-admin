    ...
    return MediaQuery(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions:[ userSave.email == "s9728401234@gmail.com" ||
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          listofadminpermissions!.contains("All") ||
                                  listofadminpermissions!.contains("Manage Admins")
                              ? InkWell(
                                  onTap: () {
                                    SearchProfile().addtoadminnotification(
                                        userid: userSave.puid!,
                        ...
                        children: [
                          ...
                          listofadminpermissions!.contains("All") ||
                                  listofadminpermissions!
                                      .contains("Manage Advertisement")
                              ? InkWell(
                                  onTap: () {
                                    if (listofadminpermissions!
                                            .contains("Can Change Advetisements") ||
                                        listofadminpermissions!.contains("All")) {
                                      SearchProfile().addtoadminnotification(
                                          userid: userSave.puid!,
                                          useremail: userSave.email!,
                                          userimage: userSave.imageUrls!.isEmpty
                                              ...
                                              : userSave.imageUrls![0],
                                          title:
                                              "${userSave.displayName} CLICK MANAGE ADVERTISIMENT IN RIGHT MENU ",
                                          email: userSave.email!,
                                          subtitle: "");
                                      Navigator.push(
                                          context,
                              ...
                              ? InkWell(
                                  onTap: () {
                                    ...
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => const ManageBubbles(),
                                        ));
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          listofadminpermissions!.contains("All") ||
                                  listofadminpermissions!.contains("Manage Charts")
                              ? InkWell(
                                  onTap: () {
                                    SearchProfile().addtoadminnotification(
                                        userid: "212",
