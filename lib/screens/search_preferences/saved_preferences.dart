...
class SearchPreferences extends StatefulWidget {
 ...
 final List<HistorySavePref> history_save_pref;
  const SearchPreferences({Key? key, required this.history_save_pref, required this.newUserModel}) : super(key: key);
              ...
              (val[0].isEmpty && val[1].isEmpty && val[2].isEmpty)
                  ? Text(
                      ...
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.w400,
                          fontFamily: 'Sans-serif'),)
                  : (val[0].isNotEmpty&& val[1].isNotEmpty && val[2].isNotEmpty)
                      ? SizedBox(
                        width: Get.width*0.2,
                        child: SingleChildScrollView(
                          scrollDirection: Axis.horizontal,
...
for (var i = 0; i < svp.LocatioList[2].length; i++) {
   selectedState!.add({"name":svp.LocatioList[2][i]});
                  ...
                  for (var i = 0; i < widget.history_save_pref[index].citylocation.length; i++) {
   selectedCity!.add({"name":widget.history_save_pref[index].citylocation[i]});
}
for (var i = 0; i < widget.history_save_pref[index].location.length; i++) {
   selectedCounty!.add({"name":widget.history_save_pref[index].location[i]});
   
}
for (var i = 0; i < widget.history_save_pref[index].statelocation.length; i++) {
   selectedState!.add({"name":widget.history_save_pref[index].statelocation[i]});
}
                }
...
for (var i = 0; i < svp.LocatioList[1].length; i++) {
                     ...
                     child: Column(
                      ...
                      (widget.newUserModel.religion == "Hindu")
                          ? nameContainer('images/icons/kundli.png',
                              "Kundli Dosh", svp.KundaliDoshList, sdl.KundaliDosh)
                          : Container(),
                     nameContainer(
                         ...
                         svp.MaritalStatusList,
                          sdl.MaritalStatus),
                      nameContainer('images/icons/food.png', "Diet", svp.dietList,
                          sdl.Diet),
                      ...
                      nameContainer('images/icons/disability.png', "Disability With Person",
                      ...
                      nameContainer('images/icons/hand_rupee.png', "Annual Income",
                      ...
                      //   height: 100,
                      // ),
                                       widget.history_save_pref.length>1?  Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            borderColor2 = true;
                           print(svp.AgeList);
  if(svp.LocatioList[2].contains("United States")){
  ...
  title: "${userSave.displayName} SAVE ${widget.newUserModel!.name.substring(0, 1).toUpperCase()} ${widget.newUserModel!.surname.toLowerCase()} ${widget.newUserModel!.puid} PREFERENCE", email: userSave.email!, subtitle: "");
                             HomeService().createsavepref(ageList:svp.AgeList,
                              religionList: svp.ReligionList, 
                              citylocation: svp.LocatioList[2].isEmpty?[]: svp.LocatioList[2],
                              statelocation: svp.LocatioList[1].isEmpty?[]: svp.LocatioList[1],
                              kundaliDoshList:svp.KundaliDoshList,
                              email: widget.newUserModel.email,
                               maritalStatusList:svp.MaritalStatusList,
                                heightList:svp.HeightList.isEmpty?[]: ["${sdl.Height[int.parse(svp.HeightList[0])].substring(0, 4)}Feet","${sdl.Height[int.parse(svp.HeightList[1])]}"],
                                 smokeList:svp.SmokeList,
                                 drinkList:svp.DrinkList, disabilityList:svp.DisabilityList,
                                  dietList:svp.dietList, educationList:svp.EducationList, 
                                  professionList:svp.ProfessionList, incomeList:svp.IncomeList,
                                   location:svp.LocatioList[0].isEmpty?[]: svp.LocatioList[0]);
                   HomeService().addtosavedprefprofile(ageList:svp.AgeList,
                              religionList: svp.ReligionList, 
                              email: widget.newUserModel.email,
                    ...
                    Container(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                             SearchProfile().addtoadminnotification(userid: widget.newUserModel!.id!, useremail:widget.newUserModel!.email!, userimage:widget.newUserModel!.imageurls!.isEmpty?"":widget.newUserModel!.imageurls![0], 
  title: "${userSave.displayName} RESET ${widget.newUserModel!.name.substring(0, 1).toUpperCase()} ${widget.newUserModel!.surname..toLowerCase()} ${widget.newUserModel!.puid} PREFERENCE", email: userSave.email!, subtitle: "");
                                ...
                                heightList:[],
                                 ...
                                 drinkList:[],
                                  ...
                                  professionList:[], incomeList:[],
                                   location:[]);
  HomeService().addtosavedprefprofile(ageList:[],
                              religionList: [], 
                              email: widget.newUserModel.email,
                              uid: widget.newUserModel.id,
                              citylocation: [],
      ...
      return SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    nameContainer2('images/icons/calender.png', "Age",
                        functions().AgeDialog, widget.history_save_pref[index].ageList),
                    nameContainer('images/icons/religion.png', "Religion",
                        widget.history_save_pref[index].religionList, sdl.Religion),
                     nameContainer('images/icons/kundli.png', "Kundli Dosh",
                            widget.history_save_pref[index].kundaliDoshList, sdl.KundaliDosh),
                    ...
                    nameContainer(
                        ...
                        sdl.MaritalStatus),
                    nameContainer(
                        'images/icons/food.png', "Diet", widget.history_save_pref[index].dietList, sdl.Diet),
                    nameContainer('images/icons/smoke.png', "Smoke",
                        widget.history_save_pref[index].smokeList, sdl.Smoke),
                    nameContainer('images/icons/drink.png', "Drink",
                       widget.history_save_pref[index].drinkList, sdl.Drink),
                    nameContainer('images/icons/disability.png', "Disability With Person",
                     widget.history_save_pref[index].disabilityList, sdl.Disability),
                    nameContainer2('images/icons/height.png', "Height",
                        functions().HeightDialog, widget.history_save_pref[index].heightList),
                    nameContainer('images/icons/education.png', "Education",
                       widget.history_save_pref[index].educationList, sdl.Education),
                    nameContainer('images/icons/profession_suitcase.png',
                        "Profession", widget.history_save_pref[index].professionList, sdl.Profession),
                    nameContainer('images/icons/hand_rupee.png', "Income",
                        widget.history_save_pref[index].incomeList, sdl.Income),
                    nameContainer5('images/icons/location.png', "Location",
                   
                         functions().LocationDialog,
                        
                        "${widget.history_save_pref[index].citylocation.isEmpty?"":
                        "${widget.history_save_pref[index].citylocation[0]} ${widget.history_save_pref[index].citylocation.length>1?"+${widget.history_save_pref[index].citylocation.length-1}":""}"}${widget.history_save_pref[index].statelocation.isEmpty?"":
                       ",${ widget.history_save_pref[index].statelocation[0]} ${widget.history_save_pref[index].statelocation.length>1?"+${widget.history_save_pref[index].statelocation.length-1}":""}"}${widget.history_save_pref[index].location.isEmpty?"":
                        ",${widget.history_save_pref[index].location[0]}${widget.history_save_pref[index].location.length>1?"+${widget.history_save_pref[index].location.length-1}":""} "}"),
                        //  nameContainer5(
                  ...
                  curve: Curves.easeInOut,)
                    ...
                    SizedBox(height: 10,),
                  Text(
                                 widget.history_save_pref[index].name.contains("reset")?"Reset by ${widget.history_save_pref[index].name.split(' ')[0]}":   "Saved by ${widget.history_save_pref[index].name}",
                                    style: const TextStyle(
                                        decoration: TextDecoration.none,
                                        color: Colors.black,
                                        fontSize: 22,
                                    ...
                                    Text(
                                 DateFormat('EEEE MMMM d y HH:mm').format(DateTime.parse(widget.history_save_pref[index].createdAt!).toLocal()),
                                    style: const TextStyle(
                                        decoration: TextDecoration.none,
                                        color: Colors.black,
                                        fontSize: 22,
